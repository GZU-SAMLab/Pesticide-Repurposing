...
// Tail result
//no filter
extern "C" REAL getTailLinkMRR(bool type_constrain = false)
{
    if (type_constrain)
    {
...
extern "C" REAL getTailLinkMR(bool type_constrain = false)
{
    if (type_constrain)
    {
...
extern "C" REAL getTailLinkHit10(bool type_constrain = false)
{
    if (type_constrain)
    {
        return r_tot_constrain;
    }
    return r_tot;
}
extern "C" REAL getTailLinkHit3(bool type_constrain = false)
{
    if (type_constrain)
    {
        return r3_tot_constrain;
    }
    return r3_tot;
}
extern "C" REAL getTailLinkHit1(bool type_constrain = false)
{
    if (type_constrain)
    {
        return r1_tot_constrain;
    }
    return r1_tot;
}

//filter
extern "C" REAL getFilterTailLinkMRR(bool type_constrain = false)
{
    if (type_constrain)
    {
...
extern "C" REAL getFilterTailLinkMR(bool type_constrain = false)
{
    if (type_constrain)
    {
...
extern "C" REAL getFilterTailLinkHit10(bool type_constrain = false)
{
    if (type_constrain)
    {
        return r_filter_tot_constrain;
    }
    return r_filter_tot;
}
extern "C" REAL getFilterTailLinkHit3(bool type_constrain = false)
{
    if (type_constrain)
    {
        return r3_filter_tot_constrain;
    }
    return r3_filter_tot;
}
extern "C" REAL getFilterTailLinkHit1(bool type_constrain = false)
{
    if (type_constrain)
    {
        return r1_filter_tot_constrain;
    }
    return r1_filter_tot;
}
// end tail result
