...
class Tester(object):
    ...
    def __init__(self, model=None, data_loader=None, use_gpu=True):
        ...
        self.lib.getTailLinkMRR.restype = ctypes.c_float
        self.lib.getTailLinkMR.restype = ctypes.c_float
        self.lib.getTailLinkHit10.restype = ctypes.c_float
        self.lib.getTailLinkHit3.restype = ctypes.c_float
        self.lib.getTailLinkHit1.restype = ctypes.c_float
    ...
    def run_link_prediction(self, type_constrain=True):
        self.lib.initTest()
        ...
        for index, [data_head, data_tail] in enumerate(self.data_loader):
        ...
        tail_mrr = self.lib.getTailLinkMRR(type_constrain)
        tail_mr = self.lib.getTailLinkMR(type_constrain)
        tail_hit10 = self.lib.getTailLinkHit10(type_constrain)
        tail_hit3 = self.lib.getTailLinkHit3(type_constrain)
        tail_hit1 = self.lib.getTailLinkHit1(type_constrain)
        # filter_tail_mrr = self.lib.getFilterTailLinkMRR(type_constrain)
        # filter_tail_mr = self.lib.getFilterTailLinkMR(type_constrain)
        # filter_tail_hit10 = self.lib.getFilterTailLinkHit10(type_constrain)
        # filter_tail_hit3 = self.lib.getFilterTailLinkHit3(type_constrain)
        # filter_tail_hit1 = self.lib.getFilterTailLinkHit1(type_constrain)
        return (
            mrr,
            mr,
            hit10,
